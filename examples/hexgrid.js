...
xy = xy.flat().map(([x, y, z]) => [x - 0.25, y - yShift * 0.5, z]);
...
regl.frame(({time}) => {
  ...
  drawLines([
    {...lineData, transform: mat2create()},
    {...lineData, transform: mat2rotate([], mat2create(), time * 0.1) }
  ]);
});
